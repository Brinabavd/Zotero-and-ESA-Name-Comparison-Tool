...
## Simple Levenshtein Distance Checker ##

def calculate_similarity(name1, name2):
    return lv.distance(name1.lower(), name2.lower())


## Spellcheck using Levenshtein ##
...
## Uses Exponential backoff to make more requests when encountering pushback from ##
## Crossref API ##
...
def zotero_name_scraper():
    ...
    print("Scraping Zotero Library with ID", LIBRARY_ID, "...")
    ...
    print("Finished scraping Zotero.")
##

## Excel Database Extraction ##
...
## DOI Extractor (Crossref API) ##
## Commented out for extremely long runtime, ##
## Use when you are ready and sure that your ##
## Data works with all other steps ##
